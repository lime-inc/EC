...
export declare const functionExtensions: {
    readonly types: readonly ["product_discounts", "order_discounts", "shipping_discounts", "shipping_rate_presenter", "payment_customization"];
};
...
export declare const extensions: {
    types: ("product_subscription" | "checkout_ui_extension" | "checkout_post_purchase" | "web_pixel_extension" | "pos_ui_extension" | "customer_accounts_ui_extension" | "theme" | "product_discounts" | "order_discounts" | "shipping_discounts" | "shipping_rate_presenter" | "payment_customization")[];
...
export declare const uiExternalExtensionTypes: {
    readonly types: readonly ["web_pixel", "post_purchase_ui", "checkout_ui", "pos_ui", "subscription_ui", "customer_acounts_ui"];
};
...
export declare const functionExternalExtensionTypes: {
    readonly types: readonly ["product_discount", "order_discount", "shipping_discount", "payment_customization", "delivery_option_presenter"];
};
...
export declare const externalExtensionTypes: {
    readonly types: readonly ["web_pixel", "post_purchase_ui", "checkout_ui", "pos_ui", "subscription_ui", "customer_acounts_ui", "theme_app_extension", "product_discount", "order_discount", "shipping_discount", "payment_customization", "delivery_option_presenter"];
};
...
export declare const externalExtensionTypeNames: {
    readonly types: readonly ["Web pixel", "Post-purchase UI", "Theme app extension", "Checkout UI", "POS UI", "Customer accounts UI", "Subscription UI", "Function - Product discount", "Function - Order discount", "Function - Shipping discount", "Payment customization", "Delivery option presenter"];
};
