...
import { extensions, getExtensionOutputConfig, limitedExtensions, isUiExtensionType, isFunctionExtensionType, functionExtensionTemplates, extensionTypeCategory, extensionTypeIsGated, } from '../../../constants.js';
...
export default class AppScaffoldExtension extends Command {
    async run() {
        ...
        const extensionDirectory = await scaffoldExtensionService({
            ...
            extensionFlavor,
            extensionType,
            externalExtensionType: flags.type,
            app,
