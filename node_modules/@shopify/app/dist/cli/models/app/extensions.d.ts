...
export declare const UIExtensionConfigurationSupportedSchema: schema.define.ZodObject<schema.define.extendShape<{
    ...
    type: schema.define.ZodEnum<["product_subscription", "checkout_ui_extension", "checkout_post_purchase", "web_pixel_extension", "pos_ui_extension", "customer_accounts_ui_extension", "web_pixel", "post_purchase_ui", "checkout_ui", "pos_ui", "subscription_ui", "customer_acounts_ui"]>;
}>, "strip", schema.define.ZodTypeAny, {
    version?: string | undefined;
    extensionPoints?: string[] | undefined;
    capabilities?: any;
    ...
    configuration?: any;
    name: string;
    type: "product_subscription" | "checkout_ui_extension" | "checkout_post_purchase" | "web_pixel_extension" | "pos_ui_extension" | "customer_accounts_ui_extension" | "web_pixel" | "post_purchase_ui" | "checkout_ui" | "pos_ui" | "subscription_ui" | "customer_acounts_ui";
    metafields: {
        namespace: string;
        key: string;
    }[];
...
export declare const FunctionExtensionConfigurationSchema: schema.define.ZodObject<{
    name: schema.define.ZodString;
    type: schema.define.ZodEnum<["product_discounts", "order_discounts", "shipping_discounts", "shipping_rate_presenter", "payment_customization"]>;
    ...
    name: string;
    description: string;
    type: "product_discounts" | "order_discounts" | "shipping_discounts" | "shipping_rate_presenter" | "payment_customization";
    build: {
        path?: string | undefined;
        command: string;
    };
