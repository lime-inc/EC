 ...
 */
export declare function selectOrCreateApp(localApp: AppInterface, apps: OrganizationApp[], org: Organization, token: string, cachedApiKey?: string): Promise<OrganizationApp>;
export declare function createApp(org: Organization, app: AppInterface, token: string): Promise<OrganizationApp>;
